...
const RememberMeIcon = styled.span`
    ...
    &:after {
        ...
        transition: all 0.2s ease-in-out 0s;
        transform: ${props =>
            props.rememberMe ? "scale(1) rotate(-45deg)" : "scale(0) rotate(0)"};
    }
`;
    ...
    render() {
        ...
        return (
            <LoginForm style={style}>
                ...
                <LoginBtn active={loginForm.isValid} onClick={loginForm.login}>
                    <span>登&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;录</span>
                </LoginBtn>
                <hr
                    style={{
...
class SignupModal extends React.Component {
    ...
    render() {
        const { store: { userStore: { signUpForm } }, style } = this.props;
        ...
        return (
            <LoginForm style={style}>
                ...
                <LoginBtn active={signUpForm.isFormValid} onClick={signUpForm.signup}>
                    注&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;册
                </LoginBtn>
                <hr
                    style={{
