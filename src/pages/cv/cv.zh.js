...
import {
	Avatar,ContactBtn,Icon, contactIconStyle, CvWrap, HighlightAbility, InfoItemList, InfoItemWrap, Job, Name, ProjectBlock,
			...
			<div  style={{textAlign: 'center'}}>
				...
				<div>
					<Tooltip
						...
						title="领英"
					>
						<ContactBtn href="https://cn.linkedin.com/in/zhangqing332" target="_blank">
			...
			<Card style={{width: "100%"}}>
				<div className="clearfix">
					<InfoItemList>
						...
						<InfoItemWrap>
							<Tag color="#108ee9">
								<Icon className="icon-linkedin" style={ {
									marginRight:4,
									fontSize:14
								} }/>:</Tag>
						...
						<InfoItemWrap>
							<Tag color="#108ee9"><Icon className="icon-github" style={ {
								marginRight:4,
								fontSize:14
							} }/>:</Tag>
					...
					<SelfIntro lang="zh">
						...
						<p>
							...
							熟悉 gulp, browserify, <HighlightAbility>webpack</HighlightAbility> 前端构建工具的使用。 <br/>
			...
			<TimeLineContainer>
				...
				<TimeLineSelection>
					<Card style={ {width:"100%"} }>
						...
						<TimeLineSelectionSubTitle>高级前端研发工程师</TimeLineSelectionSubTitle><br/>
						<Tag color="#2196F3">2017.09 - 至今</Tag>
						<TimeLineSelectionDescription>
							担任高级前端研发工程师, 负责AgileShot(安捷秀)套件的开发和维护,
							项目为影视项目管理工具, 分为 AgilePlan(中期)、AgileScript(前期)、AgileLine(后期) 3个模块。
						</TimeLineSelectionDescription>
				...
				<TimeLineSelection floatToRight={ true }>
					<Card style={ {width:"100%"} }>
						...
						<TimeLineSelectionDescription>
							...
							项目为单页应用,包含复杂前端逻辑, 大量使用 jquery, 使用 d3开发订制图表。
				...
				<FlexContainer style={ {margin:"0 -5px"} }>
					...
					<ProjectBlock>
						<Card style={ {width:"100%",height:"100%"} }>
							...
							<ProjectContent>
								项目前端基于 react + mobx 开发的单页面应用, 我在其中负责前端开发, 包括企业模块,
								AgilePlan网盘, 财务模块, AgileScript剧本模块, 以及各模块的成员, 权限与设置。
							</ProjectContent>
							
							<ProjectContent>
								项目中综合应用了各种前端技术, 有复杂逻辑处理(权限系统)、图表展示, 文件系统模拟,
								使我对 react技术栈有了深入的了解。
							</ProjectContent>
							<ProjectContent>
								<a href="http://agileshot.vsochina.com" target="_blank">产品地址</a>
							</ProjectContent>
						</Card>
					</ProjectBlock>
